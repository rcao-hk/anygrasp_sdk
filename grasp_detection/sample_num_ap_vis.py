...
model_list = [
    ...
    'anygrasp_ours_l1_grad_restored_conf',
    'anygrasp_drnet',
...
experiment_root_base = '/media/2TB/result/grasp/graspnet_trans_full'
...
for sample_num in sample_num_list:
    ...
    for model in model_list:
        ...
        for split in ['seen', 'similar', 'novel']:
            npy_path = os.path.join(root, f'ap_test_{split}_{camera_type}.npy')
